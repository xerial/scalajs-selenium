...
lazy val seleniumTest = project
  ...
  .settings(
    ...
    libraryDependencies += "org.wvlet.airframe" %%% "airspec" % "23.11.2" % Test,
    ...
    libraryDependencies ++= Seq(
      "org.seleniumhq.selenium" % "selenium-java"    % "4.15.0" % Test,
      "org.wvlet.airframe"    %%% "airframe-rx-html" % "23.11.2"
    ),
