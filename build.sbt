...
lazy val seleniumTest = project
  ...
  .settings(
    ...
    libraryDependencies += "org.wvlet.airframe" %%% "airspec" % "23.10.0" % Test,
    ...
    libraryDependencies ++= Seq(
      "org.seleniumhq.selenium" % "selenium-java"    % "4.14.0" % Test,
      "org.wvlet.airframe"    %%% "airframe-rx-html" % "23.10.0"
    ),
